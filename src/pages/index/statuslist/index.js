import { getHotStatuses } from '../../../common/service/userstatus/index';
...
Component({
  ...
  methods: {
    ...
    loadingMore(loadingInfo) {
      ...
      this.fetchActivities(isRefresh);
    },

    fetchActivities(isRefresh = false) {
      const that = this;
      ...
      if (isRefresh || (!isRefresh && hasMoreUserStatus)) {
        getHotStatuses({ pageKey: formerKey, perPage })
